...
import vn.phatbee.ltwebst2.services.impl.CategoryServiceEntityImpl;
...
public class CategoryController extends HttpServlet {
    ...
    public ICategoryServiceEntity cateServiceEntity = new CategoryServiceEntityImpl();
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String url = req.getRequestURI();
        if(url.contains("/admin/categories")){
            List<Category> list = cateServiceEntity.findAll();
            req.setAttribute("listcate", list);
            req.getRequestDispatcher("/views/admin/category-list.jsp").forward(req, resp);
            ...
            Category category = cateServiceEntity.findById(id);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (url.contains("/admin/category/insert")) {
            ...
            // Gọi phương thức insert và truyền model vào
            cateServiceEntity.insert(category);
            ...
            // Lưu hình cũ
            Category cateold = cateServiceEntity.findById(categoryid);
            String fileold = cateold.getImages();
            ...
            // Gọi phương thức insert và truyền model vào
            cateServiceEntity.update(category);
